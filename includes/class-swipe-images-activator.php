...
class Swipe_Images_Activator {
	 ...
	 *
	 * Löscht die Encode-Probe-Transients (swipe_images_can_encode_webp/avif) und probt danach
	 * sofort neu: ein Plugin-Update reaktiviert das Plugin, dieser Hook feuert also mit. Ohne das
	...
	public static function activate() {
		...
		Swipe_Images_Detector::can_encode( 'image/avif' );
	}
